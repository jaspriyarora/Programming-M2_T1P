...
vector<vector<int>> matrix_multiplication(vector<vector<int>> matrix_a, vector<vector<int>> matrix_b)
{
    ...
    // Check if your matrices can be multiplied
    if (num_cols_a != num_rows_b)
    {
        throw invalid_argument("Your matrices cannot be multiplied");
    }

    // Create your result matrix
...
{
    // Check if you have entered the correct number of arguments
    if (argc != 3)
    {
